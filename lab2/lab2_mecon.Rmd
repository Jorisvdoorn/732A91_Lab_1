...
First, we start with $\mu_0 = (-10, 100,-100)^T$, $\Omega_0=0.01 \cdot I_3$ , $v_0=4$ and $\sigma_0^2=1$.
...
hist(final[,1], freq=F,main="beta 0", xlab="Beta value", breaks=30)
hist(final[,2],freq=F, main="beta 1", xlab="Beta value", breaks=30)
hist(final[,3], freq=F,main="beta 2", xlab="Beta value", breaks=30)
hist(final[,4], freq=F,main="Sigma^2",xlab="Sigma^2 value", breaks=30)
